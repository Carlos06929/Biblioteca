@extends('adminlte::page') @section('title', 'Registrar Seminario')
@section('content_header')
<a href="{{route('informe.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">REGISTRAR SEMINARIO</h1>
        ...
        <form action="{{route('libro.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-7 ">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    <select class="form-control shadow-sm js-example-basic" name="idioma"placeholder="seleccione" required>
                ...
                <div class="col-xs-12 col-sm-12 col-md-11 ">
                    <label for="autor" class="form-label la">Autor:</label> {{-- TOMAR EN CUENTA QUE UN SEMINARIO NO TIENE AUTORES --}}
                ...
                <div class="col-xs-12 col-sm-12 col-md-11 ">
                    <label for="encargado" class="form-label la">Encargado:</label> {{-- TOMAR EN CUENTA QUE UN SEMINARIO NO TIENE AUTORES --}}

                    <select class="form-control shadow-sm js-example-basic" name="encargado" placeholder="seleccione" required>
            ...
            <div class="row">
                ...
                <div
                    ...
                    style="text-align: center"
                >
                    AREA DE DESCRIPCION FISICA DEL DOCUMENTO
                    <hr />
                </div>
                <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                ...
                >
                <br>
                    AREA DE DESCRIPCION DEL DOCUMENTO
                    <hr />
                </div>
