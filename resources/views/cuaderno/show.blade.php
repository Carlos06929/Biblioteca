@extends('adminlte::page') @section('title', 'Registrar Cuaderno')
@section('content_header')
<a href="{{route('cuaderno.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DEL CUADERNO</h1>
        ...
        <form action="{{route('libro.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div
                    ...
                    style="text-align: center"
                >
                    AREA DE DESCRIPCION FISICA DEL CUADERNO
                    <hr />
                </div>
                ...
                >
                <br>
                    AREA DE DESCRIPCION DEL CUADERNO
                    <hr />
                </div>
