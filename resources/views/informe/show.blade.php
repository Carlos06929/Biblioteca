@extends('adminlte::page') @section('title', 'Informacion Informe')
@section('content_header')
<a href="{{route('informe.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DEL INFORME</h1>
        ...
        <form action="{{route('libro.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div
                    ...
                    style="text-align: center"
                >
                    AREA DE DESCRIPCION FISICA DEL INFORME
                    <hr />
                </div>
                <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                ...
                >
                <br>
                    AREA DE DESCRIPCION DEL INFORME
                    <hr />
                </div>
