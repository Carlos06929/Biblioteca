@extends('adminlte::page') @section('title', 'Editar Trabajo Dirigido')
@section('content_header')
<a href="{{route('tdirigido.index')}}" class="btn btn-sm float-right">
    <button>Volver</button></a
>
<h1 class="titulo">ACTUALIZAR TRABAJO DIRIGIGO</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('tdirigido.update', $tdirigido)}}" method="POST"  enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 img">
                    ...
                    <img
                        class="imagen"
                        id="picture"
                        src="{{asset('imgs/tdirigido/'. $tdirigido->imagen)}}"
                        alt=""
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="subtitulo"  value="{{old('subtitulo',$tdirigido->subtitulo)}}"> @error('subtitulo')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="idioma"  value="{{old('idioma',$tdirigido->idioma)}}">
                    @error('idioma')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    <br />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                ...
                <select class="form-control shadow-sm js-example-basic-multiple " name="autor[]" multiple="multiple" id="autor">
                    ...
                    <option value="Alejandro Cruz Garnica">Alejandro Cruz Garnica</option>
                </select>
            ...
            <div class="row">
                ...
                <div
                    ...
                    style="text-align: center"
                ><br>
                    AREA DE DESCRIPCION DEL TRABAJO DIRIGIDO
                    <hr />
                </div>
