@extends('adminlte::page') @section('title', 'Registrar Trabajo Dirigido ')
@section('content_header')
<a href="{{route('tdirigido.index')}}" class="btn btn-sm float-right">
    <button>Volver</button></a
>
<h1 class="titulo">REGISTRAR TRABAJO DIRIGIDO</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('tdirigido.store')}}" method="POST" novalidate enctype="multipart/form-data">
            @csrf @method('POST')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="subtitulo"  value=""> @error('subtitulo')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
