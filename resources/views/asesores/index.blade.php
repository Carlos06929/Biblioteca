        ...
        <table id="miTabla" class="table ui celled table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-justify p-1">{{$asesor->nombre}}</td>


                    <td class="text-center p-1">

                        <a href="{{route('asesores.edit',[$asesor->id])}} " class="btn btn-sm btn-warning" >
                            <span>
                        ...
                        <form action="{{route('asesores.destroy',[$asesor->id])}}" style="display: inline" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-sm btn-danger btn-round" onclick="return toastr.success('Se a eliminado correctamente','asesor')">
                                <span>
