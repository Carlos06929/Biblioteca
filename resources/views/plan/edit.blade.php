@extends('adminlte::page') @section('title', 'Registrar Plan')
@section('content_header')
<a href="{{route('plan.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">ACTUALIZAR PLAN</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('plan.update', $planes)}}" method="POST" novalidate enctype="multipart/form-data">
            @csrf @method('put')
