        ...
        <table id="miTabla" class="table ui celled table ">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i++}}</td>
                    <td>
                        <a  href="/imgs/Planimages/{{$planes->image}}"
                            data-lightbox="imagen"
                            data-title="{{$planes->titulo}}"
                        >
                            <img src="{{ asset('imgs/Planimages/' . $planes->image) }}" alt="" width="60" height="70">
                        </a>
                    </td>
                    ...
                    <td>
                        <form action="{{ route('plan.destroy', $planes) }}" method="post">
                            @csrf
                            @method('delete')
                            <a href="{{ route('plan.edit', [$planes->id]) }}"
                                class="btn btn-primary btn-sm fas fa-edit  cursor-pointer"></a>

                                <a href="{{ route('plan.show', [$planes->id]) }}"
                                class="btn btn-warning btn-sm fas fa-eye  cursor-pointer"></a>

                                <a href="{{ route('plan.ejemplar', $planes) }}"
