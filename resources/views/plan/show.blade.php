@extends('adminlte::page') @section('title', 'Info Plan')
@section('content_header')
<a href="{{route('plan.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DEL PLAN</h1>
...
<div class="card shadow formulario">
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 img">
                    ...
                    <img
                        class="imagen"
                        id="picture"
                        src="{{asset('imgs/Planimages/'. $planes->image)}}"
                        alt=""
                        value="{{old('picture')}}"
                       >
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 mt-3">
                    ...
                    >{{old('signatura_topografica',$planes->signatura_topografica)}}</textarea>
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 mt-3">
                    ...
                    <option disabled selected>-Seleccione una opcion-</option>
                        ...
                        <option {{$planes->idioma==$idiomas->id ? "selected" : ""}} value="{{$idiomas->id}}">{{$idiomas->nombre}}</option>
            ...
            <div class="col-xs-11 col-sm-11 col-md-11 mt-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    <label for="pais" class="form-label la">Edicion:</label>
                    <input
                        name="edicion"
                        type="text"
                        class="form-control shadow-sm"
                ...
                >
                <br>
                    AREA DE DESCRIPCION FISICA DEL PLAN
                    <hr />
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        value="{{$planes->cantidad_paginas}}"readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="dimensiones"
                        for="dimensiones"
                        value="{{$planes->dimensiones}}"readonly
                    />
                    @error('dimensiones')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    <textarea
                        ...
                        type="text"
                        name="material_anexo"
                        id="material_anexo"readonly
                    >{{$planes->material_anexo}}</textarea>
