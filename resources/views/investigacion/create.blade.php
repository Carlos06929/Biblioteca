...
>
<h1 class="titulo">REGISTRAR INVESTIGACION</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('investigacion.store')}}" method="POST" novalidate enctype="multipart/form-data">
            @csrf @method('POST')
            ...
            <div class="row">
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 mt-3">
                    ...
                    >
                        ...
                        <option {{old("idioma")==$idiomas->id ? "selected" : ""}} value="{{$idiomas->id}}">{{$idiomas->nombre}}</option>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="tema"  value=""> @error('tema')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
