@extends('adminlte::page') @section('title', 'Registrar Investigacion')
@section('content_header')
<a href="{{route('investigacion.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">ACTUALIZAR INVESTIGACION</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('investigacion.update',$investigaciones)}}" method="POST" novalidate enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 img">
                    ...
                    <img
                        class="imagen"
                        id="picture"
                        src="{{asset('imgs/Invimages/'. $investigaciones->image)}}"
                        alt=""
                        value="{{old('picture')}}"
                       >
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 imgUser">
                    <input
                        ...
                        accept="image/*"
                        type="file"
                        value="{{asset('imgs/Invimages/'. $investigaciones->image)}}"
                        >
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    ...
                    >{{old('signatura_topografica',$investigaciones->signatura_topografica)}}</textarea>
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 mt-3">
                    <label for="idioma" class="form-label la"
                        >Idioma:</label
                    >
                    <select
                        name="idioma"
                    ...
                    >
                        ...
                        <option {{$investigaciones->idioma==$idiomas->id ? "selected" : ""}} value="{{$idiomas->id}}">{{$idiomas->nombre}}</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 ">
                    ...
                    <input
                        ...
                        id="titulo"
                        for="titulo"
                        value="{{old('titulo',$investigaciones->titulo)}}"
                    />
                    @error('titulo')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    <label for="tema" class="form-label la"
                        >Tema:</label
                    >
                    <input name="tema" type="text" class="form-control
                    shadow-sm" id="tema"  value="{{$investigaciones->tema}}"> @error('tema')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="col-xs-11 col-sm-11 col-md-11 mt-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="lugar"
                        for="lugar"
                        value="{{old('lugar',$investigaciones->lugar)}}"
                ...
                <div class="col-xs-12 col-sm-12 col-md-5">
                    ...
                    <textarea
                        ...
                        name="editorial"
                        id="editorial"
                    >{{old('editorial',$investigaciones->editorial)}}</textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        id="anio"
                        for="anio"
                        value="{{old('anio',$investigaciones->anio)}}"
                    />
                    @error('anio')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="pais"
                        for="pais"
                        value="{{old('pais',$investigaciones->pais)}}"
                    />
                    @error('pais')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
               ...
               <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        id="edicion"
                        for="edicion"
                        value="{{old('edicion',$investigaciones->edicion)}}"
                    />
                    @error('edicion')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 mt-3">
                    ...
                    <input
                        ...
                        class="form-control shadow-sm"
                        id="isbn"
                        value="{{old('isbn',$investigaciones->isbn)}}"
                    />
                    @error('isbn')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div
                    ...
                    style="text-align: center"
                >
                    AREA DE DESCRIPCION FISICA DE LA INVESTIGACION
                    <hr />
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        value="{{old('cantidad_paginas',$investigaciones->cantidad_paginas)}}"
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="dimensiones"
                        for="dimensiones"
                        value="{{old('dimensiones',$investigaciones->dimensiones)}}"
                    />
                    @error('dimensiones')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    <textarea
                        ...
                        id="material_anexo"
                        value=""
                    >{{old('material_anexo',$investigaciones->material_anexo)}}</textarea>
                ...
                >
                <br>
                    AREA DE DESCRIPCION DE LA INVESTIGACION
                    <hr />
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <textarea
                        ...
                        name="descripcion"
                        id="descripcion"
                    >{{old('descripcion',$investigaciones->descripcion)}}</textarea>
