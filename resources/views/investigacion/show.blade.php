@extends('adminlte::page') @section('title', 'Info Investigacion')
@section('content_header')
<a href="{{route('investigacion.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DE LA INVESTIGACION</h1>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 img">
                    ...
                    <img
                        class="imagen"
                        id="picture"
                        src="{{asset('imgs/Invimages/'. $investigacion->image)}}"
                        alt=""
                        value="{{old('picture')}}"
                       >
                </div>
               <br>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 mt-4">
                    ...
                    <textarea
                        ...
                        readonly>{{old('signatura_topografica',$investigacion->signatura_topografica)}}</textarea>
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 mt-4">
                    ...
                    <select
                        ...
                        <option {{$investigacion->idioma==$idiomas->id ? "selected" : ""}} value="{{$idiomas->id}}">{{$idiomas->nombre}}</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 ">
                    ...
                    <input
                        ...
                        id="titulo"
                        for="titulo"
                        value="{{old('titulo',$investigacion->titulo)}}"readonly
                    />
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="tema"  value="{{$investigacion->tema}}"
                    readonly>
            ...
            <div class="col-xs-11 col-sm-11 col-md-11 mt-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="lugar"
                        for="lugar"
                        value="{{old('lugar',$investigacion->lugar)}}"readonly
                ...
                <div class="col-xs-12 col-sm-12 col-md-5">
                    ...
                    <textarea
                        ...
                        name="editorial"
                        id="editorial"
                    readonly>{{old('editorial',$investigacion->editorial)}}</textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        id="anio"
                        for="anio"
                        value="{{old('anio',$investigacion->anio)}}"readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="pais"
                        for="pais"
                        value="{{old('pais',$investigacion->pais)}}"readonly
                    />
               ...
               <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        id="edicion"
                        for="edicion"
                        value="{{old('edicion',$investigacion->edicion)}}"readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 mt-3">
                    ...
                    <input
                        ...
                        class="form-control shadow-sm"
                        id="isbn"
                        value="{{old('isbn',$investigacion->isbn)}}"
                        readonly
                    />
                    <br />
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        value="{{old('cantidad_paginas',$investigacion->cantidad_paginas)}}"readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="dimensiones"
                        for="dimensiones"
                        value="{{old('dimensiones',$investigacion->dimensiones)}}"readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    <textarea
                        ...
                        id="material_anexo"
                        value=""
                    readonly>{{old('material_anexo',$investigacion->material_anexo)}}</textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <textarea
                        ...
                        name="descripcion"
                        id="descripcion"
                    readonly>{{$investigacion->descripcion}}</textarea>
