...
<h1>REGISTROS DE AUTORES/INSTITUCIONES</h1>
        ...
        <table id="miTabla" class="table ui celled table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-justify p-1">{{$autores->nombre}}</td>


                    <td class="text-center p-1">

                        <a href="{{route('autor.edit',[$autores->id])}} " class="btn btn-sm btn-warning" >
                            <span>
                        ...
                        <form action="{{route('autor.destroy',[$autores->id])}}" style="display: inline" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-sm btn-danger btn-round" onclick="return toastr.success('Se a eliminado correctamente','Autor')">
                                <span>
