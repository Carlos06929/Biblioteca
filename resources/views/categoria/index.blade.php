@extends('adminlte::page') @section('title', 'Categoria')
<link href="img/logoh.png" rel="icon" />
<link href="img/logoh.png" rel="apple-touch-icon" />

@section('content_header')
<h1 class="text-uppercase" >registros de categoría</h1>
        ...
        <table id="miTabla" class="table ui celled table ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-justify p-1">{{$categorias->nombre}}</td>


                    <td class="text-center p-1">

                        <a href="{{route('categoria.edit',[$categorias->id])}} " class="btn btn-sm btn-warning" >
                            <span>
                        ...
                        <form action="{{route('categoria.destroy',[$categorias->id])}}" style="display: inline" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-sm btn-danger btn-round" onclick="return toastr.success('Se a eliminado correctamente','Categoria')">
                                <span>
