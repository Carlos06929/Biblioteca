@extends('adminlte::page') @section('title', 'Actualizar Revista')
@section('content_header')
<a href="{{route('revista.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">ACTUALIZAR REVISTA</h1>
@stop @section('content')

<div class="card shadow formulario">
    <div class="card-body">
        <form action="{{route('revista.update', $revista)}}" method="POST"  enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    ...
                    >{{old('signatura_topografica',$revista->signatura_topografica)}}</textarea>
               ...
               {{--  <div class="col-xs-12 col-sm-12 col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    <select
                        ...
                        required
                    >
                        <option value="{{$revista->disponible}}">{{ucfirst($revista->disponible)}}</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="subtitulo"  value="{{old('subtitulo',$revista->subtitulo)}}"> @error('subtitulo')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="idioma"  value="{{old('idioma',$revista->idioma)}}">
                    @error('idioma')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    <br />
            ...
            <div class="col-xs-12 col-sm-12 col-md-11 ">
                ...
                <select class="form-control shadow-sm js-example-basic-multiple " name="autores[]" multiple="multiple" placeholder="seleccione" >
            ...
            <div class="col-xs-12 col-sm-12 col-md-11 mt-3">
                <label for="categorias" class="form-label la">Categoría:</label>

                <select class="form-control shadow-sm js-example-basic-multiple " name="categorias[]" multiple="multiple" id="categoria" >
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    >{{old('descripcion',$revista->descripcion)}}</textarea>
