@extends('adminlte::page') @section('title', 'Ver Revista')
@section('content_header')
<a href="{{route('revista.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DE LA REVISTA</h1>
    ...
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 img">
                    ...
                    >
                    <a
                    href="/imgs/{{$revista->image}}"
                    data-lightbox="imagen"
                    data-title="{{$revista->titulo}}"
                >
                    <img
                        class="imagen"
                        id="picture"
                        src="{{asset('imgs/'. $revista->image)}}"
                        alt=""
                       />
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    <input
                        ...
                        value="{{old('numero_inventario',$revista->numero_inventario)}}"
                        readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    <label for="numero_inventario" class="form-label la">
                        Codigo de Barras: {!!DNS1D::getBarcodeHTML($revista->numero_inventario, 'C39',1,65);!!} 
                    </label>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    >{{old('signatura_topografica',$revista->signatura_topografica)}}
                    </textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    >
                        ...
                        <option disabled selected value="disponible">Disponible</option>
                        <option disabled selected value="prestado">Prestado</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    <input
                        ...
                        id="titulo"
                        for="titulo"
                        value="{{old('titulo',$revista->titulo)}}"
                        readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="subtitulo"  value="{{old('subtitulo',$revista->subtitulo)}}" readonly>

                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    <label for="idioma" class="form-label la">Idioma:</label>
                    <input name="idioma" type="text" class="form-control
                    shadow-sm" id="idioma"  value="{{old('idioma',$revista->idioma)}}"readonly>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                ...
                <select  class="form-control shadow-sm js-example-basic-multiple " name="autor[]" multiple="multiple" id="autor" disabled >
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                ...
                <select class="form-control shadow-sm js-example-basic-multiple " name="categoria[, ]" multiple="multiple" id="categoria" disabled>
                ...
                <div class="col-xs-12 col-sm-12 col-md-5">
                    ...
                    >
                    {{old('editorial',$revista->editorial)}}
                    </textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        value="{{old('cantidad_paginas',$revista->cantidad_paginas)}}"
                        readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                    ...
                    <input
                        ...
                        id="dimensiones"
                        for="dimensiones"
                        value="{{old('dimensiones',$revista->dimensiones)}}"
                        readonly
                    />
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                    ...
                    >
                    {{old('material_anexo',$revista->material_anexo)}}
                    </textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    >
                    {{old('descripcion',$revista->descripcion)}}
                    </textarea>
