    ...
    <div class="modal" id="ModalCrear" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form role="form" action="{{route('idioma.store')}}" method="post" enctype="multipart/form-data" id="form_create">
                  @csrf
                  @method('POST')
                <!-- Modal Header -->
                 ...
                 <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col ">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nombre') is-invalid @enderror" id="nombre"  name="nombre" placeholder="Ingresa el nombre" autofocus required >
                            @error('nombre')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ 'Este idioma' }}</strong> {{old('nombre')}} <strong>{{ 'ya existe' }}</strong>
                        </span>
                       @enderror
