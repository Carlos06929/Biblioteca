@extends('adminlte::page') @section('title', 'Informacion del Proyecto')
@section('content_header')
<a href="{{route('proyecto.index')}}" class="btn btn-sm float-right">
    <button>VOlver</button></a
>
<h1 class="titulo">INFORMACION DEL PROYECTO</h1>
        ...
        <form action="{{-- {{route('libro.store')}} --}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div
                    ...
                    style="text-align: center"
                >
                    AREA DE DESCRIPCION FISICA DEL PROYECTO
                    <hr />
                </div>
                ...
                <div
                    ...
                    style="text-align: center"
                ><br>
                    AREA DE DESCRIPCION DEL PROYECTO
                    <hr />
                </div>
