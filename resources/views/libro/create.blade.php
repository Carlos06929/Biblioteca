...
>
<h1 class="titulo">REGISTRAR LIBRO</h1>
        ...
        <form action="{{route('libro.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5">
                    ...
                    <textarea name="signatura_topografica" class="form-control shadow-sm" type="text" required id="signatura_topografica">{{old('signatura_topografica')}}</textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    ...
                    shadow-sm" id="titulo" for="titulo" value="{{old('subtitulo')}}">
                    @error('subtitulo')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mt-3">
                    ...
                    <input
                        ...
                        value="{{old('otras_caracteristicas')}}"
                    />
