...
<div>
    <a href="{{route('libro.index')}}" class="btn btn-sm float-right"><button class="volver">Volver</button></a>
...
<div class="card shadow formulario">
    <div class="card-header">
       <h3>Titulo del libro : {{$libro->titulo}}</h3>
    </div>
    <div class="card-header border-warning" style="background-color: #fbaf32">
        ...
        <div >
            <a href="{{route('libro.addEjemplar',[$libro->id])}}" class="btn btn-sm btn-light float-right">
                <span>
        ...
        <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12 col-md-3" style="padding-left: 40px">
                        <form action="{{ route('libro.delEjemplar') }}" method="post">
                            @csrf
